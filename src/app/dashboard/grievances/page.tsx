    ...
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-3">
        {grievances.length === 0 ? (
          ...
          return (
            <div key={g.id} className="bg-card border border-border rounded-lg overflow-hidden hover:border-primary/30 transition-all">
              <div className="flex items-start gap-4 p-5 cursor-pointer" onClick={() => setExpanded(isExp ? null : g.id)}>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    <span className="font-mono text-xs px-2 py-0.5 bg-accent rounded border border-border">{g.category}</span>
