    ...
    <div className="p-6 space-y-6">
      ...
      {!activeDoc ? (
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {DOCS.map(({ key, label, template, icon }) => {
              ...
              return (
                <div key={key} className="bg-card border border-border rounded-lg p-6 hover:border-primary/50 transition-all">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-primary/20 rounded-lg p-2">
